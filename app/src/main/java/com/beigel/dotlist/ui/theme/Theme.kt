 ...
 */
fun priorityColor(priority: com.beigel.dotlist.data.Priority): androidx.compose.ui.graphics.Color = when (priority) {
    com.beigel.dotlist.data.Priority.HOCH    -> androidx.compose.ui.graphics.Color(0xFFF2B8B5)
    com.beigel.dotlist.data.Priority.MITTEL  -> androidx.compose.ui.graphics.Color(0xFFCCC2DC)
    com.beigel.dotlist.data.Priority.NIEDRIG -> androidx.compose.ui.graphics.Color(0xFF9FD8B5)
}